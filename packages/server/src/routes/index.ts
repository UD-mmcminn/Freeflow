...
import authRouter from '../iam/routes/auth'
import auditRouter from '../iam/routes/audit'
import userRouter from '../iam/routes/user.route'
import organizationRouter from '../iam/routes/organization.route'
import roleRouter from '../iam/routes/role.route'
import organizationUserRoute from '../iam/routes/organization-user.route'
import workspaceRouter from '../iam/routes/workspace.route'
import workspaceUserRouter from '../iam/routes/workspace-user.route'
